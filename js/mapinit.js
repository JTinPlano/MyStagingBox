    ...
    */
    ...
    function OnLoad() {
      ...
      mapContainer.style.width = '450px'; // set the map width
 ...
 //		map.setMapType(G_MAP);
     ...
     // And second, we need is a search complete callback!
      ...
      // Set the center point and finish!
      map.setCenter(new google.maps.LatLng(38.84, -97.611), 6);
    
     // Execute an initial search
      searchControl.execute('Texas');
    }
